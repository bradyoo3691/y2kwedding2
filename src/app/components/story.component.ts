            ...
            <g>
              ...
              <g>
                ...
                <text x="0" y="-16" font-size="16" text-anchor="middle" dominant-baseline="central">
                  <animate attributeName="opacity" values="0;1;0;0;0;0" keyTimes="0;0.25;0.27;0.52;0.77;1" calcMode="discrete" dur="48s" repeatCount="indefinite"/>
                  👦🏻
                </text>
                <g>
                  <animate attributeName="opacity" values="0;0;0;1;0;0" keyTimes="0;0.25;0.52;0.75;0.77;1" calcMode="discrete" dur="48s" repeatCount="indefinite"/>
